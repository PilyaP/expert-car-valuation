          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
                Незалежний експерт з транспортно-товарознавчої експертизи («12.2 – Визначення вартості КТЗ і розміру збитку…»). Свідоцтво МЮ України №22 від 27.05.1999 р. (безстроково).
              </p>
