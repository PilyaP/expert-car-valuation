...
export default function Home() {
  ...
  const handleOrderAssessment = () => {
    // Scroll to contacts and highlight phone numbers
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl text-gray-900">
                Судовий незалежний автоексперт Дніпро
              </span>
            </div>
      ...
      <div
        id="hero"
        className="bg-gradient-to-br from-slate-50 to-blue-50 pt-20 pb-16"
      >
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-4xl lg:text-5xl xl:text-6xl text-gray-900 leading-tight">
                  Оцінка авто у Дніпрі та визначення збитків при ДТП для суду та
                  офіційних процедур
                </h1>

                <h2 className="text-2xl lg:text-3xl text-gray-700 leading-relaxed mb-4">
                  Від атестованого незалежного судового експерта з понад
                  29-річним досвідом. Офіційні незалежні висновки та експертні
                  звіти для МРЕО (сервісних центрів МВС), суду, нотаріусів,
                  страхових компаній, податкових і слідчих органів, ЗСУ та
                  юридичних фірм.
                </h2>

                <p className="text-lg lg:text-xl text-gray-600 leading-relaxed mb-4">
                  Визначення вартості колісних транспортних засобів і розміру
                  збитку, завданого власнику ТЗ. Працюємо у Дніпрі та виїжджаємо
                  по всій Дніпропетровській області.
                </p>
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-blue-100">
                  <p className="text-blue-700 text-center mb-2">
                    <span className="text-xl">
                      🔹 Професійна експертна оцінка = справедливе рішення
                    </span>
                  </p>
                  <p className="text-gray-600 text-center">
                    🔹 Експертні незалежні висновки для всіх установ та
                    організацій
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">
                      Атестований незалежний експерт
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">Офіційні звіти</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-gray-900">
                      Незалежний експерт зі свідоцтвом МЮ
                    </p>
                    <p className="text-sm text-gray-500">
                      29 років експертного стажу
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-gray-900 mb-2">
                Впевненість у суді та зі страховими
              </h3>
              <p className="text-gray-600 text-sm">
                Експертні звіти, які приймають суди та установи
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-gray-900 mb-2">
                Розрахунок збитків без зайвих суперечок
              </h3>
              <p className="text-gray-600 text-sm">
                Точні розрахунки згідно методології
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-gray-900 mb-2">
                Професійно. Об'єктивно. Законно.
              </h3>
              <p className="text-gray-600 text-sm">
                29 років експертного досвіду та бездоганна репутація
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-gray-900 mb-2">
                Правдива цифра — ваш захист у суді
              </h3>
              <p className="text-gray-600 text-sm">
                Професійна оцінка, що захищає ваші інтереси
              </p>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-50 to-green-50 rounded-full border border-blue-200">
              <span className="text-blue-700">
                Професійна оцінка збитків — ваш аргумент | Чесна експертиза для
                чесного рішення
              </span>
            </div>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-8 border border-green-200 max-w-4xl mx-auto">
              ...
              <h3 className="text-2xl text-gray-900 mb-4">
                Судовий незалежний автоексперт Дніпро та область
              </h3>
              ...
              <div className="mt-6 pt-6 border-t border-green-200">
                <p className="text-gray-700 text-center">
                  🏢 <strong>Офіс:</strong> смт. Слобожанське, вул.
                  Нижньодніпровська, 1
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Професійна експертна оцінка у Дніпрі та з виїздом по
              Дніпропетровській області. Офіційні незалежні висновки для всіх
              сфер застосування
            </p>
          </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Точне визначення розміру збитку при ДТП. Офіційні
                      експертні акти для судів та страхових компаній
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-gray-900 mb-2">
                      Оцінка для суду (цивільні та кримінальні справи)
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Судова експертиза при спадкових справах, майнових спорах
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Експертна оцінка для реєстрації транспортних засобів у
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-gray-900 mb-2">
                      Експертна оцінка для нотаріуса (спадщина, розлучення,
                      угоди)
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Нотаріальне оформлення угод купівлі-продажу, дарування та
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Незалежні експертні висновки для всіх страхових компаній
                      України при врегулюванні збитків
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-gray-900 mb-2">
                      Оцінка для податкових та слідчих органів
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Офіційні висновки експерта для податкових органів, слідчих
                      органів та адвокатських запитів
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Професійна оцінка для підприємств, юридичних фірм та
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-gray-900 mb-2">
                      Визначення розміру збитків і пошкоджень авто
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Точне визначення розміру збитку, завданого власнику
                      транспортного засобу при ДТП та інших пошкодженнях
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Оформлення та експертна підтримка угод купівлі-продажу
                      авто з офіційними висновками експерта
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-gray-900 mb-2">
                      Експертна професійна оцінка обладнання
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Професійна оцінка промислового обладнання та товарів з
                      офіційними експертними актами
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Дослідження проводить незалежний експерт Пилипенко Анатолій
                  Іванович, який має вищу технічну освіту та кваліфікацію
                  судового незалежного експерта з транспортно-товарознавчої
                  експертизи відповідно до Положення про
                  експертно-кваліфікаційні комісії та атестацію судових
                  незалежних експертів за спеціальністю «12.2 – Визначення
                  вартості колісних транспортних засобів і розміру збитку,
                  завданого власнику транспортного засобу».
                </p>
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Стаж незалежної експертної діяльності з 1996 року. Свідоцтво
                  Міністерства юстиції України №22 від 27.05.1999 р.,
                  безстроково. Стаж роботи за фахом з 1982 року.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Член Союзу незалежних експертів України з 2000 року. Має
                  Сертифікат вищого ступеня Союзу незалежних експертів України А
                  №0025 від 16.10.2009 р. Включений до
                  <a
                    href="http://rase.minjust.gov.ua/"
                    target="_blank"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-gray-900 mb-1">Свідоцтво</h4>
                    <p className="text-gray-600 text-sm">№22 безстроково</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open("http://rase.minjust.gov.ua/", "_blank")
                  }
                >
      ...
      <div id="contacts" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Готові надати професійну консультацію та допомогти з незалежною
              експертною оцінкою
            </p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
                ...
                <p className="text-gray-600 mb-6">
                  Приймаємо у Дніпрі та виїжджаємо по всій Дніпропетровській
                  області. Зателефонуйте для безкоштовної консультації щодо
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900">
                      Судовий незалежний експерт Дніпро
                    </p>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Пилипенко А.І. - атестований судовий незалежний автоексперт з
                43-річним досвідом. Працюємо у Дніпрі та виїжджаємо по всій
                Дніпропетровській області. Офіційні звіти для всіх державних
                установ і приватних організацій.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400 text-sm">
              © 2025 Пилипенко А.І. Всі права захищені. Свідоцтво судового
              незалежного експерта №22
            </p>
          </div>
        </div>
      </footer>
