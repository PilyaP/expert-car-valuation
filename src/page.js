...
export default function Home() {
  ...
  const handleEmailClick = () => {
    window.location.href = 'mailto:aiexpert@ua.fm?subject=Запит на оцінку автомобіля&body=Доброго дня! Мені потрібна консультація щодо оцінки автомобіля.';
  };
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h2 className="text-2xl lg:text-3xl text-gray-700 leading-relaxed mb-4">
                  Від атестованого незалежного судового експерта з понад 29-річним досвідом. Офіційні незалежні висновки та експертні звіти для МРЕО (сервісних центрів МВС), суду, нотаріусів, страхових компаній, податкових і слідчих органів, ЗСУ та юридичних фірм.
                </h2>
      ...
      <div id="services" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service Cards */}
            <Card className="group hover:shadow-lg transition-all duration-300 border-gray-200 hover:border-blue-300 cursor-pointer"
                  onClick={handleOrderAssessment}>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Точне визначення розміру збитку при ДТП. Офіційні експертні акти для судів та страхових компаній
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Офіційні висновки експерта для податкових органів, слідчих органів та адвокатських запитів
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Професійна оцінка промислового обладнання та товарів з офіційними експертними актами
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Член Союзу незалежних експертів України з 2000 ��оку. Має Сертифікат вищого ступеня Союзу незалежних експертів України А №0025 від 16.10.2009 р. Включений до 
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  ...
                  onClick={() => window.open('http://rase.minjust.gov.ua/', '_blank')}
                >
