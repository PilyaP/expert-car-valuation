...
<h2 className="text-2xl lg:text-3xl text-gray-700 leading-relaxed mb-4">
  Від атестованого незалежного судового експерта з понад 29-річним досвідом. Офіційні незалежні висновки та експертні оцінки для митниці, МРЕО (сервісних центрів МВС), суду, нотаріусів, страхових компаній, податкових і слідчих органів, ЗСУ та юридичних фірм.
</h2>

<p className="text-lg lg:text-xl text-gray-600 leading-relaxed mb-4">
  Визначення вартості колісних транспортних засобів і розміру збитку, завданого власнику ТЗ. Професійна оцінка авто для митниці у Дніпрі та з виїздом по всій Дніпропетровській області.
</p>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Член Союзу Експертів України з 2000 року. Має Сертифікат вищого ступеня Союзу експертів України А №0025 від 16.10.2009 р. Включений до 
