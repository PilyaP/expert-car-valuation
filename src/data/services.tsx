...
import { Wrench, Scale, Car, FileText, Calculator, Package, Handshake, Shield, CarFront } from 'lucide-react'
...
export const services: ServiceCardData[] = [
  {
    ...
    desc: "Точне визначення розміру збитку при ДТП. Офіційні експертні висновки для судів та страхових компаній",
  ...
  },
  {
    ...
    desc: "Судова експертиза при спадкових справах, майнових спорах та кримінальних провадженнях",
  ...
  },
  {
    ...
    desc: "Експертна оцінка для реєстрації транспортних засобів у сервісних центрах МВС",
  ...
  },
  {
    ...
    desc: "Незалежні експертні висновки для всіх страхових компаній України при врегулюванні збитків",
  ...
  },
  {
    ...
    desc: "Офіційні незалежні висновки експерта для податкових органів, слідчих органів та адвокатських запитів",
  ...
  },
  {
    ...
    desc: "Точне визначення розміру збитку, завданого власнику транспортного засобу при ДТП та інших пошкодженнях",
  ...
  },
  {
    ...
    desc: "Оформлення та експертна підтримка угод купівлі-продажу авто з офіційними висновками експерта",
  ...
  },
  {
    ...
    desc: "Професійна оцінка промислового обладнання та товарів з офіційними експертними висновками",
  ...
  },
  {
    ...
    desc: "Визначення ринкової вартості транспортних засобів, що ввозяться на митну територію України. Офіційні експертні висновки, які приймають митні органи.",
  ...
  },
  {
    ...
    title: "Експертна оцінка для нотаріуса (спадщина, розлучення, угоди)",
    desc: "Нотаріальне оформлення угод купівлі-продажу, дарування та розподілу майна при розлученні",
  ...
  },
  {
    ...
    title: "Експертна професійна оцінка для юридичних осіб та компаній",
    desc: "Професійна оцінка для підприємств, юридичних фірм та комерційних організацій",
    icon: <Wrench className="w-6 h-6 text-yellow-600" />,
    iconBg: "bg-yellow-100",
    iconHoverBg: "group-hover:bg-yellow-200",
    ariaLabel: "Експертна професійна оцінка для юридичних осіб — детальніше",
  },
]
